...
if (
    ...
    if ($_POST['action'] == 'create') {
        try {
            ...
            $Broker->createMarketReview(TblMarketReview::TYPE_VALUE[3], $_FILES, $date);
            $message = "A new NASD daily market review was successfully uploaded";
            $responseStatus = WebPage::RESPONSE_POSITIVE;
        } catch(Exception $e) {
            $message = "NASD daily market review creation failed: ".$e->getMessage();
    ...
    if ($_POST['action'] == 'delete') {
        try {
            ...
            $message = "NASD daily market review was successfully deleted";
            $responseStatus = WebPage::RESPONSE_POSITIVE;
        } catch (Exception $e) {
            $message = "NASD daily market review deleting failed: ".$e->getMessage();
            $responseStatus = WebPage::RESPONSE_NEGATIVE;
        }
    }
