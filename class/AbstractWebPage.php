...
abstract class AbstractWebPage
{
     ...
     * @param  int $loggerId the logger.id of the user accessing this webpage
     */
    public function __construct(string $title, int $loggerId = 0)
    {
    ...
    */
    abstract public function createSideBar():string;
