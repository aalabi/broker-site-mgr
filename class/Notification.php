                        ...
                        <div style='
                            ...
                            '>
                                <div style='float:left;'>
                                    <img src='$logoUrl' style='height:58px; width:64px;'/>
                                </div>
                                <div style='clear:both;'>
                        </div>
                        <a href='" . $this->settings->getDetails()->machine->url . "' style='text-decoration:none; color:#0e1d54;'>
                            <span style='
                                color:#415f7a;
                                display: block;
                                font-size:20px;
                                ...
                                text-align: center;
                            '>
                                " . $this->settings->getDetails()->sitename . "
                            </span>
                        </a>
                    </div>
