...
class ErrorLog
{
     ...
     */
    public static function getErrorDirectoryPath(bool $isBackend = false): string
    {
        ...
        return $path.$backend.ErrorLog::DIRECTORY;
    }
    ...
    {
        $handle = fopen(ErrorLog::getErrorDirectoryPath(true) . ErrorLog::FILE, "a+");
